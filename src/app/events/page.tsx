      ...
      <div className="mb-8 flex items-end justify-between gap-6">
        <div>
          ...
          <div className="mt-3 text-xl text-[#b9c7c2]">
            Актуальные экскурсии, выставки и события музея
          </div>
        </div>
      </div>
        ...
        {data.events.map((item) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-3 text-3xl font-bold leading-tight text-[#f2f1e9]">
                {item.title}
              </div>

              {item.description ? (
                <div className="mt-4 text-lg leading-relaxed text-[#b9c7c2]">
                  {item.description}
                </div>
              ) : null}
